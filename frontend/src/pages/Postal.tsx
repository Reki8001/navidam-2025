                        ...
                        <section className="rounded-3xl border border-slate-200 bg-white p-6">
                            ...
                            <form className="mt-6 space-y-4">
                                ...
                                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                    ...
                                    <p className="text-xs text-slate-500 mt-1">React generará estos inputs según la
                                ...
                                <p className="text-sm text-slate-500">(React mostrará aquí mensajes de validación /
                                    envío)</p>
                            </form>
                        </section>
                            ...
                            <div className="mt-4 rounded-2xl bg-white overflow-hidden border border-slate-200">
                                <div className="p-6">
                                    <p className="text-sm text-slate-600">
                                        React mostrará aquí el HTML devuelto por <span
